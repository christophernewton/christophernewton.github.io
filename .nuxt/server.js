...
const createNext = (ssrContext) => (opts) => {
  ...
  if (!opts.path.startsWith('http') && ('/christophernewton.github.io/' !== '/' && !opts.path.startsWith('/christophernewton.github.io/'))) {
    opts.path = urlJoin('/christophernewton.github.io/', opts.path)
  }
  // Avoid loop redirect
